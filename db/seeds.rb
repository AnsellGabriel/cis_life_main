...
# Agreement.create!(moa_no: 'LPPI-MOA-00001', description: '', plan_id: 3, agent_id: 1, cooperative_id: 3, coop_sf: 12.5, agent_sf: 10, minimum_participation: 15, nml: 5_000_000)




# ####### LPPI: AGUINALDO-VETS-AND-ASSOCIATES-CREDIT-COOPERATIVE seed data
# coop = Cooperative.find_or_initialize_by(name: "AGUINALDO VETS AND ASSOCIATES CREDIT COOPERATIVE")
# coop.region = "NCR"
# coop.province = 'Metro Manila'
# coop.municipality = 'Quezon City'
# coop.cooperative_type = 'Credit'
# coop.street = 'Afgo Center, Natividad Ave'
# coop.email = 'avacc@coop.com'
# coop.save!

# CoopBranch.create!(name: "AVACC Branch 1", cooperative_id: 3, region: "Region 1", province: "Province 1", municipality: "Municipality 1", barangay: "Barangay 1", street: "Street 1", contact_details: "09123456789")

# CoopUser.create!(first_name: 'Rullian', last_name: 'Rong', middle_name: 'P', birthdate: FFaker::Time.date, mobile_number: '09948423385', coop_branch_id: 3, cooperative_id: 3)
# User.create!(email: 'avacc@coop.com', password: 'password', password_confirmation: 'password',  approved: true, userable_id: 3, userable_type: 'CoopUser')

# Plan.create!(name: 'Loan Payment Protection Insurance', description: 'Special term insurance for PEOPLE’S MICRO FINANCE COOP', gyrt_type: 'basic', acronym: 'LPPI')
