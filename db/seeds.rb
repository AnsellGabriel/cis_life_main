...
AgreementBenefit.create!(agreement_id: 1, proposal_id: 1, name: 'Agreement Benefit dependent', min_age: 18, max_age: 65, insured_type: 2)

ProductBenefit.create!(agreement_benefit_id: 2, premium: 500)
