# # treasury
# treasurer = Employee.create!(first_name: 'Rulian', middle_name: 'P.', last_name: 'Rong', birthdate: '1996-09-03', department_id: 26, designation: "Treasurer", branch: :head_office)
...
# # accounting
# accountant = Employee.create!(first_name: 'Rulian', middle_name: 'P.', last_name: 'Rong', birthdate: '1996-09-03', department_id: 11, designation: "Accountant", branch: :head_office)
# User.create!(email: "accountant@gmail.com",  password: 'Password123!', userable: accountant, approved: 1)

# puts 'Accountant created'

# # accounting
# auditor = Employee.create!(first_name: 'Rulian', middle_name: 'P.', last_name: 'Rong', birthdate: '1996-09-03', department_id: 27, designation: "Auditor", branch: :head_office)
