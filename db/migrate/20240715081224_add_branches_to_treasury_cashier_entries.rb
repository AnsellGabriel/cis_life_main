class AddBranchesToTreasuryCashierEntries < ActiveRecord::Migration[7.0]
  def change
    ...
    add_column :treasury_cashier_entries, :unuse, :decimal, precision: 15, scale: 2
    add_column :treasury_cashier_entries, :vat_exempt, :decimal, precision: 15, scale: 2
    add_column :treasury_cashier_entries, :zero_rated, :decimal, precision: 15, scale: 2
