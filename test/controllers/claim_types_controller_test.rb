...
class ClaimTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create claim_type" do
    assert_difference("ClaimType.count") do
      post claim_types_url, params: { claim_type: { description: @claim_type.description, name: @claim_type.name } }
    end
  ...
  test "should update claim_type" do
    patch claim_type_url(@claim_type), params: { claim_type: { description: @claim_type.description, name: @claim_type.name } }
