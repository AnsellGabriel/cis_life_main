...
class BenefitsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create benefit" do
    assert_difference("Benefit.count") do
      post benefits_url, params: { benefit: { acronym: @benefit.acronym, description: @benefit.description, name: @benefit.name } }
    end
  ...
  test "should update benefit" do
    patch benefit_url(@benefit), params: { benefit: { acronym: @benefit.acronym, description: @benefit.description, name: @benefit.name } }
