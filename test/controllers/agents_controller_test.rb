...
class AgentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create agent" do
    assert_difference("Agent.count") do
      post agents_url,
params: { agent: { agent_group_id: @agent.agent_group_id, birthdate: @agent.birthdate, first_name: @agent.first_name, last_name: @agent.last_name, middle_name: @agent.middle_name,
