...
class UserLevelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_level" do
    assert_difference("UserLevel.count") do
      post user_levels_url, params: { user_level: { active: @user_level.active, authority_level_id: @user_level.authority_level_id, user_id: @user_level.user_id } }
    end
  ...
  test "should update user_level" do
    patch user_level_url(@user_level), params: { user_level: { active: @user_level.active, authority_level_id: @user_level.authority_level_id, user_id: @user_level.user_id } }
