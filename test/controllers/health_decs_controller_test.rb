...
class HealthDecsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create health_dec" do
    assert_difference("HealthDec.count") do
      post health_decs_url, params: { health_dec: { active: @health_dec.active, question: @health_dec.question, question_sort: @health_dec.question_sort, valid_answer: @health_dec.valid_answer, with_details: @health_dec.with_details } }
    end
  ...
  test "should update health_dec" do
    patch health_dec_url(@health_dec), params: { health_dec: { active: @health_dec.active, question: @health_dec.question, question_sort: @health_dec.question_sort, valid_answer: @health_dec.valid_answer, with_details: @health_dec.with_details } }
