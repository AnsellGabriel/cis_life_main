...
class ProcessCoveragesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create process_coverage" do
    assert_difference("ProcessCoverage.count") do
      post process_coverages_url,
params: { process_coverage: { agent_id: @process_coverage.agent_id, approved_count: @process_coverage.approved_count, approved_total_coverage: @process_coverage.approved_total_coverage,
approved_total_prem: @process_coverage.approved_total_prem, denied_count: @process_coverage.denied_count, denied_total_coverage: @process_coverage.denied_total_coverage, denied_total_prem: @process_coverage.denied_total_prem, effectivity: @process_coverage.effectivity, expiry: @process_coverage.expiry, group_remit_id: @process_coverage.group_remit_id, status: @process_coverage.status } }
    end
  ...
  test "should update process_coverage" do
    patch process_coverage_url(@process_coverage),
params: { process_coverage: { agent_id: @process_coverage.agent_id, approved_count: @process_coverage.approved_count, approved_total_coverage: @process_coverage.approved_total_coverage,
approved_total_prem: @process_coverage.approved_total_prem, denied_count: @process_coverage.denied_count, denied_total_coverage: @process_coverage.denied_total_coverage, denied_total_prem: @process_coverage.denied_total_prem, effectivity: @process_coverage.effectivity, expiry: @process_coverage.expiry, group_remit_id: @process_coverage.group_remit_id, status: @process_coverage.status } }
