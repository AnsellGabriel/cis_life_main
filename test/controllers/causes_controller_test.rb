...
class CausesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cause" do
    assert_difference("Cause.count") do
      post causes_url, params: { cause: { description: @cause.description, name: @cause.name } }
    end
  ...
  test "should update cause" do
    patch cause_url(@cause), params: { cause: { description: @cause.description, name: @cause.name } }
