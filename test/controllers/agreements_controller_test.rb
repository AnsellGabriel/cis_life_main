...
class AgreementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create agreement" do
    assert_difference("Agreement.count") do
      post agreements_url,
params: { agreement: { agent_id: @agreement.agent_id, anniversary_type: @agreement.anniversary_type, claims_fund: @agreement.claims_fund, comm_type: @agreement.comm_type,
