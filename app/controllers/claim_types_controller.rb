class ClaimTypesController < ApplicationController
  ...
  def create
    ...
    if @claim_type.save
      redirect_to claim_types_path, notice: "Claim type was successfully created."
    else
  ...
  def update
    if @claim_type.update(claim_type_params)
      redirect_to claim_types_path, notice: "Claim type was successfully updated."
    else
  ...
  def destroy
    @claim_type.destroy
    redirect_to claim_types_url, notice: "Claim type was successfully destroyed.", status: :see_other
  end
