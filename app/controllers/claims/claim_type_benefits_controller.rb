...
class Claims::ClaimTypeBenefitsController < ApplicationController
  ...
  def set_claim_type_benefit
    @claim_type_benefit = Claims::ClaimTypeBenefit.find(params[:id])
    @claim_type = @claim_type_benefit.claim_type
  end

  # Only allow a list of trusted parameters through.
  def claim_type_benefit_params
    params.require(:claims_claim_type_benefit).permit(:claim_type_id, :benefit_id)
  end
end
