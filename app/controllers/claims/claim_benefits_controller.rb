...
class Claims::ClaimBenefitsController < ApplicationController
  ...
  def set_claim_benefit
    @claim_benefit = Claims::ClaimBenefit.find(params[:id])
  end

  # Only allow a list of trusted parameters through.
  def claim_benefit_params
    params.require(:claims_claim_benefit).permit(:process_claim_id, :benefit_id, :amount, :status)
  end
end
