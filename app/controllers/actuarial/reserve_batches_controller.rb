class Actuarial::ReserveBatchesController < ApplicationController
  ...
  def actuarial_reserve_batch_params
    params.require(:actuarial_reserve_batch).permit(:actuarial_reserve_id, :batch_id, :term, :rate, :coverage_less_ri, :prem_less_ri, :duration, :first_term, :second_term, :third_term,
:unearned_prem, :first_adv_prem, :second_adv_prem, :reserve, :cov_less_ret, :prem_less_ret, :unearned_pr, :first_adv_pr, :second_adv_pr, :reserve_ret)
  end
end
